...
class MonitoringService {
    constructor() {
        ...
        this.errorMetrics = [];
        this.MAX_METRICS = 1000; // Mantener solo los últimos 1000 registros
    }
    ...
    cleanup() {
        ...
        this.errorMetrics = this.errorMetrics.filter(e => e.timestamp > oneHourAgo);
    }
...
setInterval(() => {
    exports.monitoringService.cleanup();
}, 60 * 60 * 1000);
