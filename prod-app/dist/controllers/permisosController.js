...
exports.actualizarConfiguracionPermisos = exports.obtenerConfiguracionPermisos = exports.actualizarPermisosUsuario = exports.eliminarUsuario = exports.actualizarUsuario = exports.crearUsuario = exports.obtenerUsuariosConsultorio = exports.verificarPermiso = exports.obtenerMisPermisos = void 0;
...
exports.obtenerMisPermisos = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (req.user) {
        ...
        const usuarioBD = await prisma_1.default.usuario.findUnique({
...
exports.verificarPermiso = [
    (0, validation_1.validateParams)(zod_1.z.object({
        permiso: zod_1.z.string().min(1, 'El permiso es requerido')
    })),
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
        const { permiso } = (0, validation_1.getValidatedParams)(req);
...
exports.obtenerUsuariosConsultorio = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        ...
        const todosLosUsuarios = await prisma_1.default.usuario.findMany({
            select: {
                id: true,
                nombre: true,
                apellido: true,
...
exports.crearUsuario = [
    (0, validation_1.validateBody)(validationSchemas_1.createUsuarioSchema),
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
        const validatedData = (0, validation_1.getValidatedBody)(req);
        const { nombre, apellido, email, telefono, rol, password } = validatedData;
        // Verificar si el email ya existe
        const usuarioExistente = await prisma_1.default.usuario.findFirst({
            where: { email }
        });
        if (usuarioExistente) {
...
exports.actualizarUsuario = [
    (0, validation_1.validateParams)(validationSchemas_1.usuarioIdSchema),
    (0, validation_1.validateBody)(validationSchemas_1.updateUsuarioSchema),
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
        ...
        if (!usuarioExistente) {
            throw (0, errorHandler_1.createNotFoundError)('Usuario');
        }
...
exports.actualizarPermisosUsuario = [
    (0, validation_1.validateParams)(validationSchemas_1.usuarioIdSchema),
    (0, validation_1.validateBody)(validationSchemas_1.updatePermisosSchema),
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
        const { id } = (0, validation_1.getValidatedParams)(req);
        const permisos = (0, validation_1.getValidatedBody)(req);
        ...
        const permisosActualizados = await prisma_1.default.usuario.update({
            where: { id },
            data: datosPermisos,
            select: {
                id: true,
...
exports.obtenerConfiguracionPermisos = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
...
exports.actualizarConfiguracionPermisos = [
    (0, validation_1.validateBody)(validationSchemas_1.updateConfiguracionPermisosSchema),
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
        const configuracion = (0, validation_1.getValidatedBody)(req);
