...
router.get('/', (0, asyncHandler_1.asyncHandler)(async (req, res) => {
  ...
  `;
    ...
    const servicios = await prisma_1.default.servicio.findMany({
        where: {
...
router.put('/:id', (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    const servicio = await prisma_1.default.servicio.update({
        where: { id },
        data: {
            nombre,
            descripcion: descripcion || null,
...
router.delete('/:id', (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    const conceptosUsandoServicio = await prisma_1.default.cobroConcepto.findFirst({
...
router.get('/:id/usos', (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
