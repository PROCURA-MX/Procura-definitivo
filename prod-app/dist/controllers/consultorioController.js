...
exports.deleteConsultorio = exports.updateConsultorio = exports.createConsultorio = exports.healthCheck = exports.getDoctorDelConsultorio = exports.getConsultorioById = exports.getConsultoriosUsuario = exports.getAllConsultorios = void 0;
const prisma_1 = __importDefault(require("../prisma"));
const asyncHandler_1 = require("../utils/asyncHandler");
exports.getAllConsultorios = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    const currentUserResult = await prisma_1.default.$queryRaw `
  ...
  `;
    ...
    const consultorios = await prisma_1.default.$queryRaw `
...
exports.getConsultoriosUsuario = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    // Obtener el usuario autenticado
    const authenticatedUser = req.user;
    if (!authenticatedUser) {
        return res.status(401).json({ error: 'Usuario no autenticado' });
    ...
    if (user.rol === 'DOCTOR') {
        ...
        try {
            ...
            consultorios = await prisma_1.default.$queryRaw `
      ...
      `;
            ...
            consultorios = await prisma_1.default.consultorio.findMany({
...
exports.getConsultorioById = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    const consultorio = await prisma_1.default.consultorio.findUnique({ where: { id } });
    if (!consultorio)
...
exports.getDoctorDelConsultorio = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        const { AvailabilityService } = await Promise.resolve().then(() => __importStar(require('../services/availabilityService')));
        const context = {
...
exports.createConsultorio = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
  ...
  `;
    ...
    try {
        ...
        const consultorio = await prisma_1.default.consultorio.create({
            data: {
                nombre,
                direccion,
...
exports.updateConsultorio = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    const { nombre, direccion } = req.body;
    const consultorio = await prisma_1.default.consultorio.update({
        where: { id },
        data: { nombre, direccion },
    });
    res.json(consultorio);
});
exports.deleteConsultorio = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    ...
    const consultorio = await prisma_1.default.consultorio.findFirst({
        where: {
            id,
    ...
    const dependencias = await prisma_1.default.$queryRaw `
    SELECT 
  ...
  `;
    ...
    try {
        ...
        await prisma_1.default.consultorio.delete({ where: { id } });
